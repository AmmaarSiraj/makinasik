...
import {
    ...
    FaChartBar, FaFilter, FaCheckCircle, FaEdit, FaLayerGroup, FaCalendarDay
} from 'react-icons/fa';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setListPerencanaan(resAllPerencanaan.data.data || resAllPerencanaan.data);
                ...
                if (subKegiatanData && subKegiatanData.tanggal_mulai) {
                    ...
                    allKelompokData.forEach(k => {
                        if (String(k.id_perencanaan) === String(id)) return; // Skip current planning
                        ...
                        if (subMonth !== bulanKegiatan) return;
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl font-extrabold text-gray-900 flex items-center gap-3">
                            ...
                            Edit Perencanaan Tim
                        </h1>
                        <p className="text-sm text-gray-500 mt-2 ml-1">
                            Atur ulang anggota tim dan alokasi honor untuk kegiatan ini.
                        </p>
                    </div>
