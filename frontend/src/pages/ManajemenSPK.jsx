  ...
  return (
    <div className="w-full pb-20 pt-8 px-8 animate-fade-in-up">
      ...
      <div className="mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <Link to="/spk/templates/create" className="bg-[#1A2A80] text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-blue-900 flex items-center gap-2"><FaPlus /> Buat Master Template</Link>
      </div>
